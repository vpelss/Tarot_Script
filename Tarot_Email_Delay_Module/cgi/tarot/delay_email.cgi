...
#load up common variables and routines. IMPORTANT: must be full path to file as the cron job doesn't like relative paths
require '/home/boilover/public_html/cgi/tarot/delay_email_vars.cgi';
